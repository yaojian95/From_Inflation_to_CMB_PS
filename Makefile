...
INC  = -I/global/common/sw/cray/cnl7/haswell/gsl/2.5/intel/19.0.3.199/7twqxxq/include
LIBS = -L/global/common/sw/cray/cnl7/haswell/gsl/2.5/intel/19.0.3.199/7twqxxq/lib -lgsl -lgslcblas
...
run_1.o                 : BackgroundCosmology.h RecombinationHistory.h Perturbations.h PowerSpectrum.h
...
run1: run_1.o Utils.o BackgroundCosmology.o RecombinationHistory.o Perturbations.o PowerSpectrum.o Spline.o ODESolver.o
	${CC} -o $@ $^ $C $(INC) $(LIBS)
